...
# ---------------------------------------------------------------------------
# VENDORED FROM UPSTREAM - DO NOT EDIT BY HAND.
#
# Source: https://github.com/apache/superset/blob/6.1.0/docker/docker-bootstrap.sh
# Tag:    6.1.0
#
# This file is copied verbatim from the apache/superset repository. This
# deployment bind-mounts ./docker over /app/docker, which REPLACES the
# directory shipped in the image, so these bootstrap scripts have to exist
# here or every service fails to start.
#
# On a Superset version upgrade, re-sync this file from the matching tag and
# diff it before deploying. See DEPLOYMENT.md > Upgrade procedure.
# ---------------------------------------------------------------------------
